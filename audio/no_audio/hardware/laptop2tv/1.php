...
if (isset($_POST['submitting'])) {
    ...
    if (($device === "windows") || ($device === "mac") || ($device === "linux") || ($device === "chromebook")) {
        $message = "ID: $id \n
        Laptop type: $device";
...
<form id="issue_type" action="1.php" method="post">
    ...
    <label for="device">What type of operating system is the laptop running?</label>
