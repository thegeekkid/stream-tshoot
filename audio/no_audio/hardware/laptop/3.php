...
<ol>
    ...
    <li>Once that's done, please trace the cable that goes from your speakers/headphones to your computer and unplug and plug it back in again.</li>
    <p>It may look like this if plugged into a headphone jack:</p>
    <img src="../../../../images/1-8th_in.jpg" />
    <p>Or like this if it is plugged into a USB port:</p>
